const translations = {
    en: {
        ...
        "about-text": "Hi, my name is Benjamin, I am 15 years old and I am from Argentina. I am learning frontend development and improving my skills every day.",
    ...
    es: {
        ...
        "about-text": "Hola, mi nombre es Benjamin, tengo 15 años y soy de Argentina. Estoy aprendiendo desarrollo frontend y mejorando mis habilidades cada día.",
    ...
    ja: {
        ...
        "about-title": "自己紹介",
        "about-text": "こんにちは、私の名前はベンジャミンです。15歳でアルゼンチン出身です。私はフロントエンド開発を学んでおり、日々スキルを向上させています。",
        "languages-title": "言語",
        "skills-title": "技術スキル",
